        ...
        <div class="col-span-12 md:col-start-5 lg:col-start-auto md:col-span-8 lg:col-span-4">
          <div class="bg-white p-5 pb-[30px] rounded-3xl h-full">
            <div class="flex flex-col h-full divide-y divide-grey">
              ...
              <!-- Price, CTA Button -->
              <div class="items-center justify-between gap-4 pt-5 mt-auto">
                <div>
                  <p class="font-bold text-dark text-[22px] pb-2">
                    {{ "Rp " . number_format($item->price,2,',','.') }} <span class="text-base font-normal text-secondary">/day</span>
                  </p>
                </div>
        ...
        @foreach ($similiarItems as $similiarItem)
          ...
          <div class="card-popular">
            ...
            <div class="flex items-center justify-between gap-1">
              <!-- Price -->
              <p class="text-sm font-normal text-secondary">
                <span class="text-base font-bold text-primary">{{ "Rp " . number_format($similiarItem->price,2,',','.') }}</span>/day
              </p>
              <!-- Rating -->
