  ...
  <section class="bg-darkGrey relative py-[70px]">
    <div class="container">
      ...
      <div class="flex items-center gap-5 lg:justify-between">
          ...
          <div class="flex flex-col gap-[30px]">
            <div class="flex flex-col gap-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <p class="text-base font-semibold">
                  {{ "Rp " . number_format($booking->item->price,2,',','.') }} per day
                </p>
              </div>
              <!-- Items -->
              <div class="flex items-center justify-between">
                ...
                <p class="text-base font-semibold">
                  {{ "Rp ". number_format($booking->item->price * $booking->start_date->diffInDays($booking->end_date) * (10 / 100),2,',','.') }}
                </p>
              </div>
              <!-- Items -->
              <div class="flex items-center justify-between">
        ...
        <img src="{{ $booking->item->thumbnail }}" class="max-w-[50%] hidden lg:block -mr-[100px] rounded-lg" alt="">
